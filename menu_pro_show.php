...
@keyframes fadeIn {
  ...
  <div class="site-wrap">
    ...
    <div class="site-navbar bg-white py-2">
     ...
     <?php include "Menu_show.php"; ?> 


     <div class="custom-border-bottom py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.html">หน้าหลัก</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">เมนู</strong></div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          ?>
            ...
            <a  href="detail_menu_pro_show.php?Pro_id=<?php echo $Pro_id ?>" class="product-item md-height bg-gray d-block">
