              ...
              <form action="add_to_menu.php" method="post" enctype="multipart/form-data">
                ...
                <div class="p-3 p-lg-5 border">
                  <div class="form-group row">
                     <div class="col-md-2">
                      <label for="Menu_id" class="text-black">สินค้า<span class="text-danger">*</span></label>
                      <input type="text" class="form-control" id="Menu_id" name="Menu_id" >
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-6">
                      <label for="Menu_name" class="text-black">ส่งเดือนละครั้ง<span class="text-danger">*</span></label>
                      <input type="text" class="form-control" id="Menu_name" name="Menu_name" value="">
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-6">
                      <label for="Menu_ingredients" class="text-black">ส่งอาทิตละครั้ง <span class="text-danger">*</span></label>
                      <input type="text" class="form-control" id="Menu_ingredients" name="Menu_ingredients" value="">
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-6">
                      <label for="Menu_cook" class="text-black">วิธีการทำ <span class="text-danger">*</span></label>
                      <input type="text" class="form-control" id="Menu_cook" name="Menu_cook" value="">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    <div class="col-md-12">
                      <label for="Pro_id" class="text-black">รหัสสินค้า </label>
                ...
                <!-- <div class="form-group row">
                 ...
                 <div class="form-group">
                        <div class="col-sm-12 text-right ">
                            <button type="submit" class="btn btn-primary btn-lg btn-block" onclick="alert('คุณได้เเก้ไขข้อมูลเเล้ว')"
