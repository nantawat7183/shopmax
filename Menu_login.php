          ...
          <div class="main-nav d-none d-lg-block">
            <nav class="site-navigation text-right text-md-center" role="navigation">
              <ul class="site-menu js-clone-nav d-none d-lg-block">
                ...
                <li><a href="shop_show.php">สั่งซื้อ</a></li>
                
                
                <li><a href="menu_pro_show.php">เมนู</a></li>
                <li><a href="Property_show.php">สรรพคุณ</a></li>
                <li><a href="#">โปรโมชั่น</a></li>
                <li><a href="status_show.php">ติดตามสินค้า</a></li>
                <li><a href="payment_show.php">ชำระเงิน</a></li>
                <li><a href="#">สมัคสมาชิก/ลงชื่อใช่งาน</a></li>
