            ...
            <div class="col-md-12">
              ...
              <form action="#" method="post">
                ...
                <div class="p-3 p-lg-5 border">
                  ...
                  <div class="form-group row">
                    <div class="col-md-6">
                      <label for="Pro_name" class="text-black">ชื่อ <span class="text-danger">*</span></label>
                      <input type="text" class="form-control" id="Pro_name" name="Pro_name" >
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-6">
                      <label for="Pro_price" class="text-black">ส่วนผสม <span class="text-danger">*</span></label>
                      <input type="text" class="form-control" id="Pro_price" name="Pro_price" >
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-6">
                      <label for="Pro_amount" class="text-black">วิธีการทำ <span class="text-danger">*</span></label>
