...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 05, 2020 at 07:35 AM
...
(904847378, '2020-01-28 05:00:53', 'nantawatuser', '72 หมู่ ตใทรายมูล', 'nantawut.d@kkumail.c', 3, 4, 'ส่งทุกเดือน'),
...
(601007841, 'บร็อคโคลี่', 40, 10, 'asdf', 'asdf', 'images/601007841.jpg', 0, 0),
...
--
ALTER TABLE `order`
  MODIFY `Or_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=967384335;

--
-- AUTO_INCREMENT for table `order_detail`
--
ALTER TABLE `order_detail`
  MODIFY `Datail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=242;
